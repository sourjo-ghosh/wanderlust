...
const Banner = () => {
  return (
    <div className="bg-[url('/assets/banner.png')] text-white  flex justify-between flex-col items-center  gap-5 min-h-180">
      ...
      <div className="bg-white/30 hidden md:flex lg:flex justify-between gap-5 w-full items-center">
        <div className="px-3">
